...
from schemas import CorridorComputeRequest, CorridorResponse
...
async def query_corridors(
    ...
    from db.queries import query_corridors_by_city
    ...
    if gdf is None or gdf.empty:
        from fallback import generate_demo_corridors
...
async def compute_corridors(req: CorridorComputeRequest):
    ...
    from db.queries import query_grid_by_bbox
    ...
    # 執行 LCP
    from core.wind.lcp import identify_corridors_multi_direction, identify_wind_corridors
    ...
    # 組裝回應
    from core.wind.lcp import _deg_to_label
