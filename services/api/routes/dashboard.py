...
def _table_exists(conn, table_name: str) -> bool:
    ...
    from db.session import table_exists
...
async def get_dashboard_stats():
    ...
    try:
        ...
        from fallback import generate_demo_stats
...
async def get_grid_cells(
    ...
    try:
        ...
        from fallback import generate_demo_grids
...
async def get_fai_data(
    ...
    try:
        ...
        from fallback import generate_demo_fai
